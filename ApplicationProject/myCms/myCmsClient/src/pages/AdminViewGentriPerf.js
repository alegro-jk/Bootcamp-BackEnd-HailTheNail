...
function AdminViewGentriPerf()
{
   ...
   const apiGetMinatozaki = () => {
       fetch("/summary/gentri/minatozaki")
   ...
   var[total3, Total3] = useState(0);
    ...
    <div className="store">
            ...
            <div className="content">
                <div>
                    <h1 id='title'>GENTRI Staffs Performance</h1>
...
export default AdminViewGentriPerf;
